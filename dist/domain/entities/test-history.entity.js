...
class TestHistory {
    constructor(id, userId, licenseType, score, isParalysisFailed, durationSeconds, examSetId, createdAt) {
        this.id = id;
        this.userId = userId;
    ...
    getResultStatus() {
        ...
        const requirements = {
            ...
            [enums_1.LicenseType.A3]: 23, [enums_1.LicenseType.A4]: 23,
            [enums_1.LicenseType.D]: 42, [enums_1.LicenseType.E]: 42, [enums_1.LicenseType.F]: 42
        };
